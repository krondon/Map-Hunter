-- Migration: Improve Wallet Ledger Descriptions
-- Created: 2026-02-19
-- Purpose: 
-- 1. Ensure 'distribute_event_prizes' logs winnings to 'wallet_ledger'.
-- 2. Translate 'resolve_event_bets' descriptions to Spanish.

-- 1. Update distribute_event_prizes to log to wallet_ledger
...
-- 2. Update resolve_event_bets for Spanish descriptions
