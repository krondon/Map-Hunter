-- Migration: Update use_power_mechanic RPC (Targeting & Integrity)
-- Date: 2026-02-16
-- Description: Updates the RPC to ensure spectator power usage targets the selected player (p_target_id)
--              instead of the caster, and enforces defense mutual exclusivity and attack blocking.
