...
$source = "C:\Users\natac\.gemini\antigravity\brain\2172836a-2969-42d0-9ccc-76316eed3889\uploaded_media_1769370038564.png"

# Dimensions based on 1024x769
$w = 256
$h = 384 
...
# Row 1: Females (Top row in image)
...
# Row 2: Males (Bottom row in image)
...
Write-Host "Processed High-Res Avatars."
