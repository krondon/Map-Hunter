...
class _DrinkMixerMinigameState extends State<DrinkMixerMinigame> {
  ...
  void _handleWin() {
    ...
    if (_cocktailsServed >= _targetCocktails) {
      ...
      HapticFeedback.heavyImpact();
      _showOverlayState(
        title: "┬íMAESTRO COCTELERO!",
        message: "Has servido los $_targetCocktails c├│cteles con ├⌐xito.",
        victory: true,
      );
    } else {
      HapticFeedback.mediumImpact();
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Icon(Icons.flag, color: AppTheme.dangerRed, size: 22),
                      ],
                    ),
                  ),
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: const Text("SERVIR C├ôCTEL", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900)),
                                        ),
                                      ),
                                    ],
                                  ),
                ...
                onGoToShop: _showShopButton ? () async {
                  ...
                  if (context.mounted) {
                    setState(() {
                      ...
                      _overlayMessage = "┬íVidas recargadas!";
                    });
                  }
                } : null,
                onExit: () {
